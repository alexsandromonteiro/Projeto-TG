...
$sql = "SELECT id_itens_pedido, 
descricao_item, tipo_item, imagem, composicao FROM itens
WHERE tipo_item = 'lanche'";
$resultado_lanche = mysqli_query($conexao, $sql); 
?>
...
<?php
while($row_lanche = mysqli_fetch_assoc($resultado_lanche)) { 
    extract($row_lanche);
?>
    ...
    <div class="container mt-3">
        ...
        <div class="card mb-3 text-center border-dark" style="max-width: 540px; margin: 0 auto">
            <div class="row">
                ...
                <div class="col">
                    <div class="card-body">
                        <h5 class="card-title"><span><?php echo $descricao_item ?></span></h5>
